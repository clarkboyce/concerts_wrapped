...
function Slide8({ 
  ...
  const handleShare = async () => {
    const shareUrl = 'https://clarkboyce.github.io/concerts_wrapped/'; // Replace with your actual URL
    ...
    <div className="w-full h-full flex flex-col items-center justify-between p-6">
      ...
      <div className="grid grid-cols-2 gap-4 w-full">
        ...
        >
          ...
          <p className="text-xl">{numConcerts}</p>
        </motion.div>
        ...
        >
          ...
          <p className="text-xl">{topArtist}</p>
        </motion.div>
        ...
        >
          ...
          <p className="text-xl">{topSeason}</p>
        </motion.div>
        ...
        >
          ...
          <p className="text-xl">{topGenre}</p>
        </motion.div>
        ...
        >
          ...
          <p className="text-xl">{topVenue}</p>
        </motion.div>
      </div>
